...
public class MoveTrigger extends Trigger implements BiTargetTrigger {
    ...
    public Properties createProperties() {
        ...
        properties.putIntProperty(LevelObjectProperty.MOVE_OFFSET_X, moveOffsetX);
        properties.putIntProperty(LevelObjectProperty.MOVE_OFFSET_Y, moveOffsetY);
        ...
        properties.putBooleanProperty(LevelObjectProperty.LOCK_TO_PLAYER_X, lockToPlayerX);
        properties.putBooleanProperty(LevelObjectProperty.LOCK_TO_PLAYER_Y, lockToPlayerY);
        properties.putBooleanProperty(LevelObjectProperty.MOVE_USE_TARGET, useMoveTarget);
        properties.putMoveTargetExclusionProperty(LevelObjectProperty.MOVE_TARGET_EXCLUSION, targetCoordinateExclusion);
        properties.putIntProperty(LevelObjectProperty.TARGET_GROUP_ID, targetGroupID);
        properties.putIntProperty(LevelObjectProperty.SECOND_TARGET_GROUP_ID, targetPositionGroupID);
