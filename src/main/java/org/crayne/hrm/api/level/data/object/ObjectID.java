...
public class ObjectID {
    ...
    @NotNull
    public static LevelObjectType findType(final int objectID) {
        return switch (objectID) {
            case 1839, 1840, 1841, 1842 -> LevelObjectType.PULSATING;
            case 85, 86, 87, 97, 137, 138, 139, 154, 155, 156,
                    180, 181, 182, 183, 184, 185, 186, 187, 188,
                    222, 223, 224, 375, 376, 377, 378, 394, 395,
                    396, 678, 679, 680, 740, 741, 742, 997, 998,
                    ...
                    1525, 1526, 1527, 1528, 1582, 1619, 1620, 1705,
                    1706, 1707, 1708, 1709, 1710, 1734, 1735, 1736,
                    1752, 1831, 1832, 1833, 1834 -> LevelObjectType.ROTATING;
            case 914 -> LevelObjectType.TEXT;
            case 1615 -> LevelObjectType.ITEM_COUNTER;
            case 31 -> LevelObjectType.START_POS_TRIGGER;
            case 899 -> LevelObjectType.COLOR_TRIGGER;
            case 901 -> LevelObjectType.MOVE_TRIGGER;
            case 1006 -> LevelObjectType.PULSE_TRIGGER;
            case 1594 -> LevelObjectType.TOGGLE_ORB;
            case 36, 84, 141, 1022, 1330, 1333, 1704, 1751 -> LevelObjectType.ORB;
            case 13, 47, 111, 200, 201, 202, 203, 660, 1331, 1334 -> LevelObjectType.SPECIAL_PROPERTY_PORTAL;
            case 747 -> LevelObjectType.TELEPORT_PORTAL;
            case 1816 -> LevelObjectType.COLLISION_BLOCK;
            case 1275, 1587, 1589, 1598, 1614 -> LevelObjectType.PICKUP_ITEM;
            case 1007 -> LevelObjectType.ALPHA_TRIGGER;
            case 1049, 1812 -> LevelObjectType.TOGGLE_TRIGGER;
            case 1268 -> LevelObjectType.SPAWN_TRIGGER;
            case 1346 -> LevelObjectType.ROTATE_TRIGGER;
            case 1347 -> LevelObjectType.FOLLOW_TRIGGER;
            case 1520 -> LevelObjectType.SHAKE_TRIGGER;
            case 1585 -> LevelObjectType.ANIMATE_TRIGGER;
            case 1595 -> LevelObjectType.TOUCH_TRIGGER;
            case 1611 -> LevelObjectType.COUNT_TRIGGER;
            case 1616 -> LevelObjectType.STOP_TRIGGER;
            case 1811 -> LevelObjectType.INSTANT_COUNT_TRIGGER;
            case 1814 -> LevelObjectType.FOLLOW_PLAYERY_TRIGGER;
            case 1815 -> LevelObjectType.COLLISION_TRIGGER;
            case 1817 -> LevelObjectType.PICKUP_TRIGGER;
            case 1, 2, 3, 4, 5, 6, 7, 8, 15, 16, 17, 39, 62, 63, 64, 65, 66, 68, 69,
                    70, 71, 72, 73, 74, 75, 76, 77, 78, 80, 81, 82, 83, 90, 91, 92, 93, 94,
                    95, 96, 103, 116, 117, 118, 119, 120, 121, 122, 143, 144, 145, 146, 147,
                    170, 171, 172, 173, 174, 175, 176, 177, 178, 179, 192, 194, 197, 204, 205,
                    ...
                    1844, 1845, 1846, 1847, 1848,
                    1858, 1886, 1887, 1888, 1889, 1890, 1891, 1892, 1893, 1894, 1895, 1896, 1897,
                    1898, 1899, 1900, 1901, 1902 -> LevelObjectType.COLORABLE;
            default -> LevelObjectType.ANY;
        };
    }
