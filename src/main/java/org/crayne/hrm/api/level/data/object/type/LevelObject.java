...
public class LevelObject {
    ...
    public Properties createProperties() {
        ...
        properties.putIntProperty(LevelObjectProperty.OBJECT_ID, objectID);
        properties.putFloatProperty(LevelObjectProperty.X_POSITION, positionX);
        properties.putFloatProperty(LevelObjectProperty.Y_POSITION, positionY);
        properties.putBooleanProperty(LevelObjectProperty.FLIPPED_HORIZ, flippedHorizontally);
        properties.putBooleanProperty(LevelObjectProperty.FLIPPED_VERT, flippedVertically);
        properties.putFloatProperty(LevelObjectProperty.ROTATION, rotation);
        properties.putIntProperty(LevelObjectProperty.EDITOR_L1, editorLayer1);
        properties.putIntProperty(LevelObjectProperty.EDITOR_L2, editorLayer2);
        properties.putZLayerProperty(objectID, zLayer);
        properties.putZOrderProperty(objectID, zOrder);
        properties.putFloatProperty(LevelObjectProperty.SCALING, scaling);
        properties.putIntegerArrayProperty(LevelObjectProperty.GROUP_IDS, groupIDs);
        properties.putBooleanProperty(LevelObjectProperty.GROUP_PARENT, groupParent);
        properties.putBooleanProperty(LevelObjectProperty.DONT_FADE, dontFade);
        properties.putBooleanProperty(LevelObjectProperty.DONT_ENTER, dontEnter);
        properties.putBooleanProperty(LevelObjectProperty.DISABLE_GLOW, disableGlow);
        properties.putBooleanProperty(LevelObjectProperty.HIGH_DETAIL, highDetailObject);
        properties.putIntProperty(LevelObjectProperty.LINKED_GROUP_ID, linkedGroupID);
    ...
    public boolean samePosition(@NotNull final LevelObject other) {
        return this.positionX == other.positionX && this.positionY == other.positionY;
    }

    public boolean sameObjectType(@NotNull final LevelObject other) {
        return this.objectID == other.objectID;
    }

    public boolean samePositionAndType(@NotNull final LevelObject other) {
        return samePosition(other) && sameObjectType(other);
    }
    
    public static boolean samePosition(@NotNull final LevelObject obj, @NotNull final LevelObject other) {
        return obj.samePosition(other);
    }

    public static boolean sameObjectType(@NotNull final LevelObject obj, @NotNull final LevelObject other) {
        return obj.sameObjectType(other);
    }

    public static boolean samePositionAndType(@NotNull final LevelObject obj, @NotNull final LevelObject other) {
        return obj.samePositionAndType(other);
    }
