package org.crayne.hrm.api.level.data.object.type.trigger;
...
public class Trigger extends LevelObject { // transition triggers are not counted as trigger objects, since they do not have any of the below parameters and are only treated like normal level objects
    ...
    public Properties createProperties() {
        ...
        properties.putBooleanProperty(LevelObjectProperty.TOUCH_TRIGGERED, touchTriggered);
        properties.putBooleanProperty(LevelObjectProperty.SPAWN_TRIGGERED, spawnTriggered);
        properties.putBooleanProperty(LevelObjectProperty.MULTI_TRIGGERED, multiTriggered);
